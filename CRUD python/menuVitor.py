...
def op1():
    ...
    with open("C:/Users/u23623/Documents/GitHub/Python-and-HTLM/python/CRUD python/informacoes.txt", "a") as arquivo:
...
def op2 ():
    ...
    with open("C:/Users/u23623/Documents/GitHub/Python-and-HTLM/python/CRUD python/informacoes.txt", "r+")as arquivo:
